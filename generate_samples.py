...
def format_obstacles(load_polys='random_squares_1.npy', cx=100, cy=100):
...
def generate_samples(cx, cy, load_polys='random_squares_1.npy', num_samples=2):
    object_c = format_obstacles(load_polys=load_polys)
    sample_set = []
